...
./bin/statblock-pfsrd -o ../data/ -d ../../PathfinderOpenReference/pfsrd-data/book-b1.db
./bin/statblock-pfsrd -o ../data/ -d ../../PathfinderOpenReference/pfsrd-data/book-b2.db
./bin/statblock-pfsrd -o ../data/ -d ../../PathfinderOpenReference/pfsrd-data/book-b3.db
./bin/statblock-pfsrd -o ../data/ -d ../../PathfinderOpenReference/pfsrd-data/book-b4.db
